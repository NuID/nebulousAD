...
from nebulousAD.modimpacket import nmb, ntlm, uuid, crypto
from nebulousAD.modimpacket.smb3structs import *
from nebulousAD.modimpacket.nt_errors import STATUS_SUCCESS, STATUS_MORE_PROCESSING_REQUIRED, STATUS_INVALID_PARAMETER, \
...
#            pass
    ...
    def listPath(self, shareName, path, password = None):
        ...
        try:
            ...
            res = ''
            files = []
            from nebulousAD.modimpacket import smb
            while True:
                try:
