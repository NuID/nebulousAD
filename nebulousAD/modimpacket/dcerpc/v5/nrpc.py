...
from nebulousAD.modimpacket.dcerpc.v5.ndr import NDRCALL, NDRSTRUCT, NDRENUM, NDRUNION, NDRPOINTER, NDRUniConformantArray, \
    NDRUniFixedArray, NDRUniConformantVaryingArray
from nebulousAD.modimpacket.dcerpc.v5.dtypes import WSTR, LPWSTR, DWORD, ULONG, USHORT, PGUID, NTSTATUS, NULL, LONG, UCHAR, PRPC_SID, \
    GUID, RPC_UNICODE_STRING, SECURITY_INFORMATION, LPULONG
from nebulousAD.modimpacket import system_errors, nt_errors
from nebulousAD.modimpacket.uuid import uuidtup_to_bin
from nebulousAD.modimpacket.dcerpc.v5.enum import Enum
from nebulousAD.modimpacket.dcerpc.v5.samr import OLD_LARGE_INTEGER
from nebulousAD.modimpacket.dcerpc.v5.lsad import PLSA_FOREST_TRUST_INFORMATION
from nebulousAD.modimpacket.dcerpc.v5.rpcrt import DCERPCException
from nebulousAD.modimpacket.structure import Structure
from nebulousAD.modimpacket import ntlm, crypto, LOG
import hmac, hashlib
try:
...
# 2.2.1.1.2 STRING
from nebulousAD.modimpacket.dcerpc.v5.lsad import STRING
...
from nebulousAD.modimpacket.dcerpc.v5.samr import SAMPR_LOGON_HOURS
