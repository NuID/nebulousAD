...
from modimpacket.krb5.asn1 import AS_REQ, AP_REQ, TGS_REQ, KERB_PA_PAC_REQUEST, KRB_ERROR, PA_ENC_TS_ENC, AS_REP, TGS_REP, \
...
from modimpacket.krb5.types import KerberosTime, Principal, Ticket
from modimpacket.krb5.gssapi import CheckSumField, GSS_C_DCE_STYLE, GSS_C_MUTUAL_FLAG, GSS_C_REPLAY_FLAG, \
    GSS_C_SEQUENCE_FLAG, GSS_C_CONF_FLAG, GSS_C_INTEG_FLAG
from modimpacket.krb5 import constants
from modimpacket.krb5.crypto import Key, _enctype_table, InvalidChecksum
from modimpacket.smbconnection import SessionError
from modimpacket.spnego import SPNEGO_NegTokenInit, TypesMech, SPNEGO_NegTokenResp, ASN1_OID, asn1encode, ASN1_AID
from modimpacket.krb5.gssapi import KRB5_AP_REQ
from modimpacket import nt_errors, LOG
from modimpacket.krb5.ccache import CCache
        ...
        try:
            ...
            if str(e).find('KDC_ERR_ETYPE_NOSUPP') >= 0:
                if lmhash is '' and nthash is '' and (aesKey is '' or aesKey is None):
                    from modimpacket.ntlm import compute_lmhash, compute_nthash
