...
from modimpacket.dcerpc.v5.dtypes import ULONG, RPC_UNICODE_STRING, FILETIME, PRPC_SID, USHORT
from modimpacket.dcerpc.v5.ndr import NDRSTRUCT, NDRUniConformantArray, NDRPOINTER
from modimpacket.dcerpc.v5.nrpc import USER_SESSION_KEY, CHAR_FIXED_8_ARRAY, PUCHAR_ARRAY, PRPC_UNICODE_STRING_ARRAY
from modimpacket.dcerpc.v5.rpcrt import TypeSerialization1
...
from modimpacket.dcerpc.v5.nrpc import PGROUP_MEMBERSHIP_ARRAY
