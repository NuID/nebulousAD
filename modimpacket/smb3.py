...
from modimpacket import nmb, ntlm, uuid, crypto, LOG
from modimpacket.smb3structs import *
from modimpacket.nt_errors import STATUS_SUCCESS, STATUS_MORE_PROCESSING_REQUIRED, STATUS_INVALID_PARAMETER, \
...
class SMB3:
    ...
    def kerberosLogin(self, user, password, domain = '', lmhash = '', nthash = '', aesKey='', kdcHost = '', TGT=None, TGS=None):
        ...
        from modimpacket.krb5.asn1 import AP_REQ, Authenticator, TGS_REP, seq_set
        from modimpacket.krb5.kerberosv5 import getKerberosTGT, getKerberosTGS
        from modimpacket.krb5 import constants
        from modimpacket.krb5.types import Principal, KerberosTime, Ticket
