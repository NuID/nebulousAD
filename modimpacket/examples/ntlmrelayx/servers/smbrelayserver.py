...
from modimpacket import smb, ntlm, LOG, smb3
from modimpacket.nt_errors import STATUS_MORE_PROCESSING_REQUIRED, STATUS_ACCESS_DENIED, STATUS_SUCCESS
from modimpacket.spnego import SPNEGO_NegTokenResp, SPNEGO_NegTokenInit, TypesMech
from modimpacket.smbserver import SMBSERVER, outputToJohnFormat, writeJohnOutputToFile
from modimpacket.spnego import ASN1_AID, MechTypes, ASN1_SUPPORTED_MECH
from modimpacket.examples.ntlmrelayx.servers.socksserver import activeConnections
from modimpacket.examples.ntlmrelayx.utils.targetsutils import TargetsProcessor
from modimpacket.smbserver import getFileTime
from modimpacket.dcerpc.v5 import transport, scmr
