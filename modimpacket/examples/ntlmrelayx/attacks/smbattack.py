...
from modimpacket.examples.ntlmrelayx.attacks import ProtocolAttack
from modimpacket.examples.ntlmrelayx.utils.tcpshell import TcpShell
from modimpacket import smb3, smb
from modimpacket.examples import serviceinstall
from modimpacket.smbconnection import SMBConnection
from modimpacket.examples.smbclient import MiniImpacketShell
...
class SMBAttack(ProtocolAttack):
    ...
    def run(self):
        ...
        if self.config.exeFile is not None:
            ...
            from modimpacket.examples.secretsdump import RemoteOperations, SAMHashes
            from modimpacket.examples.ntlmrelayx.utils.enum import EnumLocalAdmins
            samHashes = None
            try:
