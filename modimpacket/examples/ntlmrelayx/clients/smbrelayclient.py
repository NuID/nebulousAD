...
from modimpacket.examples.ntlmrelayx.clients import ProtocolClient
from modimpacket.examples.ntlmrelayx.servers.socksserver import KEEP_ALIVE_TIMER
from modimpacket.nt_errors import STATUS_SUCCESS, STATUS_ACCESS_DENIED, STATUS_LOGON_FAILURE
from modimpacket.ntlm import NTLMAuthNegotiate, NTLMSSP_NEGOTIATE_ALWAYS_SIGN, NTLMAuthChallenge
from modimpacket.smb import SMB, NewSMBPacket, SMBCommand, SMBSessionSetupAndX_Extended_Parameters, \
...
from modimpacket.smb3 import SMB3, SMB2_GLOBAL_CAP_ENCRYPTION, SMB2_DIALECT_WILDCARD, SMB2Negotiate_Response, \
...
from modimpacket.smbconnection import SMBConnection, SMB_DIALECT, SessionError
from modimpacket.spnego import SPNEGO_NegTokenInit, SPNEGO_NegTokenResp, TypesMech
from modimpacket.dcerpc.v5.transport import SMBTransport
from modimpacket.dcerpc.v5 import scmr
