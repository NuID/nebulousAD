...
from modimpacket import smb, smb3, nmb, nt_errors, LOG
...
class SMBConnection:
    ...
    def kerberosLogin(self, user, password, domain='', lmhash='', nthash='', aesKey='', kdcHost=None, TGT=None,
        ...
        from modimpacket.krb5.kerberosv5 import KerberosError
    ...
    def listShares(self):
        ...
        from modimpacket.dcerpc.v5 import transport, srvs
