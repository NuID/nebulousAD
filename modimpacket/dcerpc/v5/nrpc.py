...
from modimpacket.dcerpc.v5.ndr import NDRCALL, NDRSTRUCT, NDRENUM, NDRUNION, NDRPOINTER, NDRUniConformantArray, \
    NDRUniFixedArray, NDRUniConformantVaryingArray
from modimpacket.dcerpc.v5.dtypes import WSTR, LPWSTR, DWORD, ULONG, USHORT, PGUID, NTSTATUS, NULL, LONG, UCHAR, PRPC_SID, \
    GUID, RPC_UNICODE_STRING, SECURITY_INFORMATION, LPULONG
from modimpacket import system_errors, nt_errors
from modimpacket.uuid import uuidtup_to_bin
from modimpacket.dcerpc.v5.enum import Enum
from modimpacket.dcerpc.v5.samr import OLD_LARGE_INTEGER
from modimpacket.dcerpc.v5.lsad import PLSA_FOREST_TRUST_INFORMATION
from modimpacket.dcerpc.v5.rpcrt import DCERPCException
from modimpacket.structure import Structure
from modimpacket import ntlm, crypto, LOG
import hmac, hashlib
try:
...
# 2.2.1.1.2 STRING
from modimpacket.dcerpc.v5.lsad import STRING
...
from modimpacket.dcerpc.v5.samr import SAMPR_LOGON_HOURS
